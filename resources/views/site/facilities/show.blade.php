                            ...
                            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control"
                                        placeholder="Enter Your Email" value="{{ $facility->email }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="phone_number" name="phone_number" type="text" class="form-control"
                                        placeholder="2887385893" minlength="10" maxlength="10"
                                        value="{{ $facility->phone_number }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="number_of_beds" name="number_of_beds" type="text" class="form-control"
                                        placeholder="Number of Beds" value="{{ $facility->number_of_beds ?? 'N/A' }}"
                                        readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="city" name="city" type="text" class="form-control"
                                        placeholder="City" value="{{ $facility->city }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="state" name="state" type="text" class="form-control"
                                        placeholder="State" value="{{ $facility->state }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="country" name="country" type="text" class="form-control"
                                        placeholder="State" value="{{ $facility->country->name }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="postal_code" name="postal_code" type="text" class="form-control"
                                        placeholder="Postal Code" value="{{ $facility->postal_code }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="opening_hours" name="opening_hours" type="time"
                                        class="form-control" value="{{ $facility->opening_hours }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="closing_hours" name="closing_hours" type="time"
                                        class="form-control" value="{{ $facility->closing_hours ?? 'N/A' }}"
                                        readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="emergency_contact" name="emergency_contact" type="text"
                                        ...
                                        maxlength="15" value="{{ $facility->postal_code ?? 'N/A' }}" readonly>
                                </div>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="website" name="website" type="text" class="form-control"
                                        ...
                                        value="{{ $facility->website ?? 'N/A' }}" readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input type="text" id="longitude" name="longitude" class="form-control"
                                        ...
                                        value="{{ old('longitude', $facility->longitude ?? null) }}" required
                                        readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="latitude" name="latitude" type="text" class="form-control"
                                        ...
                                        value="{{ old('latitude', $facility->latitude ?? null) }}" required readonly>
                                ...
                                <div class="input-area">
                                    ...
                                    <textarea id="address" name="address" type="text" class="form-control" placeholder="address" rows="4"
                                        readonly>{{ $facility->address }}</textarea>
