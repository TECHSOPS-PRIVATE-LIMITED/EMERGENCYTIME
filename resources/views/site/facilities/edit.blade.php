                            ...
                            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                                ...
                                <div class="input-area">
                                    ...
                                    <select id="type" name="type" class="form-control" required>
                                        ...
                                        <option value="hospital" @selected($facility->type === 'hospital')>{{ __('Hospital') }}
                                        </option>
                                        <option value="clinic" @selected($facility->type === 'clinic')>{{ __('Clinic') }}</option>
                                        <option value="consultancy" @selected($facility->type === 'consultancy')>{{ __('Consultancy') }}
                                        </option>
                                        <option value="daycare" @selected($facility->type === 'daycare')>{{ __('Daycare') }}
                                        </option>
                                        <option value="lab" @selected($facility->type === 'lab')>{{ __('Lab') }}
                                        </option>
                                        <option value="diagnostic" @selected($facility->type === 'diagnostic')>{{ __('Diagnostic') }}
                                        </option>
                                    </select>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control"
                                        placeholder="Enter Your Email" value="{{ old('email', $facility->email) }}"
                                        required>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="phone_number" name="phone_number" type="text" class="form-control"
                                        placeholder="2887385893" minlength="10" maxlength="10" required
                                ...
                                <div class="input-area">
                                    ...
                                    <select id="hipaa_status" name="hipaa_status" class="form-control">
                                        ...
                                        <option value="yes" @selected($facility->hipaa_status === 'yes')>{{ __('Yes') }}
                                        </option>
                                        <option value="no" @selected($facility->hipaa_status === 'no')>{{ __('No') }}
                                        </option>
                                    </select>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="city" name="city" type="text" class="form-control"
                                        placeholder="City" value="{{ old('city', $facility->city) }}" required>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="state" name="state" type="text" class="form-control"
                                        placeholder="State" value="{{ old('state', $facility->state) }}" required>
                                ...
                                <div class="input-area">
                                    ...
                                    <select id="country_id" name="country_id" class="form-control" required>
                                        @foreach ($countries as $country)
                                            <option value="{{ $country->id }}" @selected($facility->country->id == $country->id)>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="emergency_contact" name="emergency_contact" type="text"
                                        class="form-control" placeholder="Emergency Contact No." minlength="11"
                                        maxlength="15"
                                ...
                                <div class="input-area">
                                    <label for="address" class="form-label">{{ __('Address') }}<span
                                            class="text-red-500">*</span></label>
                                    <textarea id="address" name="address" type="text" class="form-control" placeholder="address" rows="4">{{ old('address', $facility->address) }}</textarea>
